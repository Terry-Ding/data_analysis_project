...
def read_file(filename: str) -> (dict[str, Date],
    ...
    >>> read_file('data_analysis_project/project/csv_file/uvic/0lines_data.csv')
    ({}, {}, {}, {})
    
    >>> read_file('data_analysis_project/project/csv_file/uvic/11lines_data.csv')  # doctest: +NORMALIZE_WHITESPACE
    ({'81217749': (2019, 11, 15),
      '70303496': (2018, 9, 6),
      '70142798': (2018, 9, 5),
      '80999063': (2018, 10, 5),
...
def query(filename: str, category: str, date: Date, actors: list[str]
    ...
    >>> query('data_analysis_project/project/csv_file/uvic/0lines_data.csv', 'Comedies', (2019, 9, 5), ['Aamir Khan'])
    []
    
    >>> query('data_analysis_project/project/csv_file/uvic/11lines_data.csv', 'Comedies', (2019, 9, 5), [])
    [('3 Idiots', '70121522'), ('PK', '70303496')]

    >>> query('data_analysis_project/project/csv_file/uvic/11lines_data.csv', 'Comedies', (2019, 9, 5), ['Aamir Khan'])
    [('3 Idiots', '70121522'), ('PK', '70303496')]
        
    >>> query('data_analysis_project/project/csv_file/uvic/11lines_data.csv', 'Comedies', (2019, 9, 5), ['Sanjay Dutt'])
    [('PK', '70303496')]
    
    >>> query('data_analysis_project/project/csv_file/uvic/11lines_data.csv', 'International Movies', (2019, 9, 5), \
    ['Aamir Khan', 'Mona Singh', 'Achita Sikamana'])
    [('3 Idiots', '70121522'), ('PK', '70303496'), ('Shutter', '70062814')]
    
    >>> query('data_analysis_project/project/csv_file/uvic/11lines_data.csv', 'International Movies', (2019, 8, 1), \
              ['Aamir Khan', 'Mona Singh', 'Achita Sikamana'])
    ...
    >>> query('data_analysis_project/project/csv_file/uvic/large_data.csv', 'Comedies', (2019, 9, 5), \
              ['Aamir Khan', 'Mona Singh', 'Achita Sikamana']\
             ) # doctest: +NORMALIZE_WHITESPACE
    [('3 Idiots', '70121522'), ('Andaz Apna Apna', '20258084'),
     ('PK', '70303496')]
    
    >>> query('data_analysis_project/project/csv_file/uvic/large_data.csv', 'Comedies', (2020, 9, 5), \
              ['Aamir Khan', 'Mona Singh', 'Achita Sikamana']\
             ) # doctest: +NORMALIZE_WHITESPACE
    [('3 Idiots', '70121522'), ('Andaz Apna Apna', '20258084'),
    ...
    >>> query('data_analysis_project/project/csv_file/uvic/large_data.csv', 'International Movies', (2020, 9, 5), \
              ['Aamir Khan', 'Mona Singh', 'Achita Sikamana']\
             ) # doctest: +NORMALIZE_WHITESPACE
    [('3 Idiots', '70121522'), ('Andaz Apna Apna', '20258084'), 
    ...
    >>> query('data_analysis_project/project/csv_file/uvic/input.csv', 'stick insect category', (2017, 9, 28), ['Connie Blum', 'Dada Berardi', 'Bob Koenig', 'Kanta MacAoidh','Uchenna MacAoidh'])
    []
    >>> query('data_analysis_project/project/csv_file/uvic/input3.csv', 'International Movies', (2019, 7, 28), [])
    [('Out of Thin Air', '80119349'), ('PK', '70303496'), ('Phobia 2', '70142798'), ('Shutter', '70062814')]

    >>> query('data_analysis_project/project/csv_file/uvic/large_data.csv', 'Documentaries', (2018, 7, 13), [])
